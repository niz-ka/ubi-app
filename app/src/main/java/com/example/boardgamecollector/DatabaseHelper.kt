...
class DatabaseHelper(context: Context) :
    ...
    companion object {
        ...
        private const val SQL_DELETE_SETTINGS =
            "DROP TABLE IF EXISTS ${DatabaseSchema.Settings.TABLE_NAME}"
        ...
        private const val SQL_DELETE_GAMES =
            "DROP TABLE IF EXISTS ${DatabaseSchema.Games.TABLE_NAME}"

        private const val SQL_CREATE_RANKS =
